...
<table width="828" height="522" border="0" bordercolor="red" align="center" cellpadding="0" cellspacing="0" id="__01">
<tr><!--表1，红色线-->
...
<tr>
<td height="270" valign="top"><table width="626" height="100%" border="0" bordercolor="blue" cellpadding="0" cellspacing="0"><!-- 表2，蓝色线-->
<tr>
<td height="257" align="center" valign="top" background="images/image_08.gif"><table width="600" height="257" border="0" bordercolor="#f0f" cellpadding="0" cellspacing="0">
<!--表3，紫色线-->
<tr>
<td height="22" align="center" valign="top" class="word_orange"><strong>添加公告信息</strong></td>
</tr>
<tr>
<td height="235" align="center" valign="top"><table width="500" height="226" border="0" bordercolor="#0f0" cellpadding="0" cellspacing="0">
<!--表4，绿色线-->
<tr>
<td height="226" align="center" valign="top"><form name="form1" method="post" action="check_add_affiche.php">
<table width="520" height="212" border="0" bordercolor="#f70" cellpadding="0" cellspacing="0" bgcolor="#fff"><!--表5，橙红色-->
<tr>
