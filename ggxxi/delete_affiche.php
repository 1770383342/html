...
function check(form){
	if(form.txt_keyword.value==""){
		alert("请输入查询关键字！");
		form.txt_keyword.focus(); return false;
	}
	//form.submit();
}
</script>
...
<tr><td width="202" rowspan="3" valign="top" bgcolor="#f0f0f0"><table width="202" border="0" cellpadding="0" cellspacing="0">
<tr>
...
if(isset($_POST["Submit"])){
	...
	$sql=mysqli_query($link,"select * from tb_affiche where title like '%$keyword%' or content like '%$keyword%'");
	$row=mysqli_fetch_object($sql);
}
if(!$row){
