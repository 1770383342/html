...
<tr align="center" >
<td width="93" height="40" class="word_red"><strong>编号</strong></td>
<td width="109" height="40" class="word_red"><strong>书名</strong></td>
<td width="80" height="40" class="word_red"><strong>作者</strong></td>
<td width="82" height="40" class="word_red"><strong>出版社</strong></td>
<td width="47" height="40" class="word_red"><strong>库存</strong></td>
<td width="66" height="40" class="word_red"><strong>编辑</strong></td>
</tr>
<?php
include("conn.php");
$no=$_SESSION['no'];
...
if(!$row){
	echo"<font color='red'>没有这本书！！</font>";
		...
		do{
            ...
            <td class="word_black" height="30"><strong><a href="borrow_ok.php?id=<?php echo $row->book_id; ?>">借书</a></strong></td>
			</tr>
            <?php
