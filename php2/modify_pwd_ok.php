...
<td width="65" bgcolor="#FFFF99" class="word_orange"><a href="reader.php"><strong>借书</strong></a></td>
<td width="76" bgcolor="#FFFF99" class="word_orange"><a href="return.php"><strong>还书</strong></a></td>
<td width="115" bgcolor="#FFFF99" class="word_orange"><a href="grinformation.php"><strong>个人信息</strong></a></td>
<td width="84" bgcolor="#FFFF99" class="word_orange"><a href="login.php"><strong>退出</strong></a></td>
<td width="84" bgcolor="#FFFF99" class="word_orange"><a href="zhuxiao.php"><strong>注销</strong></a></td>
</tr>
</table>
...
if($password1==$password2){
	...
	if($password1==$pwd){echo "<script>
	 alert('和原密码相同！！');
	 window.location.href='modify_pwd_ok.php'</script>";
	 }else{
	$result=$mysqli->query("update tb_reader_php set reader_pwd='".$password1."' where reader_id='".$no."' ");
	//var_dump($result);
 if($result){
	 echo "<script>
	 alert('修改成功！！');
	 window.location.href='grinformation.php'</script>";
	 }else{
		 echo "<script>
	 alert('修改失败！！');
	 window.location.href='modify_pwd_ok.php'</script>";
