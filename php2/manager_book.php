...
<td width="100" height="40" class="word_red"><strong>图书编号</strong></td>
<td width="103" height="40" class="word_red"><strong>书名</strong></td>
<td width="59" height="40" class="word_red"><strong>作者</strong></td>
<td width="84" height="40" class="word_red"><strong>出版社</strong></td>
<td width="59" height="40" class="word_red"><strong>库存</strong></td>
<td width="72" height="40" class="word_red"><strong>编辑</strong></td>
</tr>
<?php
include("conn.php");
//$no=$_SESSION['no'];
$sql=$mysqli->query("select * from tb_book_php");
$row=$sql->fetch_object();
if(!$row){
	echo"<font color='red'>暂时没有书籍！！</font>";
	}else{
if(isset($_POST["Submit"])){
	$keyword=$_POST["txt_keyword"];
	$sql=$mysqli->query("select * from tb_book_php where book_name like '%$keyword%'");		
	$row=$sql->fetch_object();
	}
if(!$row){
	echo"<font color='red'>没有这本书！！</font>";
		...
		do{
			...
			<td class="word_black" height="30"><strong><?php echo $row->book_count; ?></strong></td>
            <td class="word_black" height="30"><strong><a href="book_del.php?id=<?php echo $row->book_id; ?>">删除</a></strong></td>
			</tr>
            <?php
...
<tr>
<td width="68" height="30" class="word_red"  align="center"><a href="book_add.php">添加</a></td>
</tr>
</table>
</td>
</tr>
